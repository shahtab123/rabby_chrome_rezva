...
export class WalletController extends BaseController {
  ...
  resolvePaymentIdentifier = async (raw: string) => {
    return resolveSendInput(raw, {
  ...
  getRezvaConfig = () => getRezvaPublicConfig();

  setRezvaConfig = (next: { apiKey?: string; apiBaseUrl?: string }) =>
    setRezvaRuntimeConfig(next);
}
